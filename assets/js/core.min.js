...
function(n, s) {
    ...
    function c(t) {
...
}(window.Zepto || window.jQuery, (window, void document)), jQuery(document).ready(function(r) {
        var a = 2500,
            s = 3800,
            l = s - 3e3,
            n = 50,
        ...
        function p(t) {
            ...
            t.parents(".cd-headline").hasClass("type") ? ((e = t.parent(".cd-words-wrapper")).addClass("selected").removeClass("waiting"), setTimeout(function() {
                ...
                m(o, c)
            }, u)) : t.parents(".cd-headline").hasClass("letters") ? (i = t.children("i").length >= o.children("i").length, function t(e, i, o, n) {
                e.removeClass("in").addClass("out");
                e.is(":last-child") ? o && setTimeout(function() {
                    p(g(i))
                }, a) : setTimeout(function() {
                    t(e.next(), i, o, n)
                }, n); {
                    var s;
                    e.is(":last-child") && r("html").hasClass("no-csstransitions") && (s = g(i), y(i, s))
                }
            }(t.find("i").eq(0), t, i, n), f(o.find("i").eq(0), o, i, n)) : t.parents(".cd-headline").hasClass("clip") ? t.parents(".cd-words-wrapper").animate({
                width: "2px"
            }, h, function() {
                y(t, o), m(o)
            }) : t.parents(".cd-headline").hasClass("loading-bar") ? (t.parents(".cd-words-wrapper").removeClass("is-loading"), y(t, o), setTimeout(function() {
                p(o)
            }, s), setTimeout(function() {
                t.parents(".cd-words-wrapper").addClass("is-loading")
            }, l)) : (y(t, o), setTimeout(function() {
                p(o)
            }, a))
        }

        function m(t, e) {
            t.parents(".cd-headline").hasClass("type") ? (f(t.find("i").eq(0), t, !1, e), t.addClass("is-visible").removeClass("is-hidden")) : t.parents(".cd-headline").hasClass("clip") && t.parents(".cd-words-wrapper").animate({
                width: t.width() + 10
            }, h, function() {
                setTimeout(function() {
                    p(t)
        ...
        r(".cd-headline.letters").find("b").each(function() {
            ...
            function(t) {
                ...
                t.each(function() {
                    var t, e, i, o = r(this);
                    o.hasClass("loading-bar") ? (n = s, setTimeout(function() {
                        o.find(".cd-words-wrapper").addClass("is-loading")
                    }, l)) : o.hasClass("clip") ? (e = (t = o.find(".cd-words-wrapper")).width() + 10, t.css("width", e)) : o.hasClass("type") || (e = o.find(".cd-words-wrapper b"), i = 0, e.each(function() {
                        var t = r(this).width();
                        i < t && (i = t)
    ...
    function(m, n, t, f) {
        ...
        function c(t, e) {
            this.element = t, this.options = m.extend({}, i, e), this._defaults = i, this._name = o, this.init()
        }
        c.prototype = {
            init: function() {
            ...
            _defineElements: function() {
                this.element === t.body && (this.element = n), this.$scrollElement = m(this.element), this.$element = this.element === n ? m("body") : this.$scrollElement, this.$viewportElement = this.options.viewportElement !== f ? m(this.options.viewportElement) : this.$scrollElement[0] === n || "scroll" === this.options.scrollProperty ? this.$scrollElement : this.$scrollElement.parent()
            },
            ...
            refresh: function(t) {
                var i = this,
                    e = i._getScrollLeft(),
                    o = i._getScrollTop();
                t && t.firstLoad || this._reset(), this._setScrollLeft(0), this._setScrollTop(0), this._setOffsets(), this._findParticles(), this._findBackgrounds(), t && t.firstLoad && /WebKit/.test(navigator.userAgent) && m(n).on("load", function() {
            ...
            _findParticles: function() {
                ...
                this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function(t) {
                    ...
                    }), o = l.data("stellar-horizontal-offset") !== f ? l.data("stellar-horizontal-offset") : s !== f && s.data("stellar-horizontal-offset") !== f ? s.data("stellar-horizontal-offset") : p.horizontalOffset, n = l.data("stellar-vertical-offset") !== f ? l.data("stellar-vertical-offset") : s !== f && s.data("stellar-vertical-offset") !== f ? s.data("stellar-vertical-offset") : p.verticalOffset, p.particles.push({
                        $element: l,
                        $offsetParent: s,
            ...
            _findBackgrounds: function() {
                ...
                this.backgrounds = [], this.options.parallaxBackgrounds && (t = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (t = t.add(this.$element)), t.each(function() {
                    ...
                    s.data("stellar-backgroundStartingLeft") ? g(s, s.data("stellar-backgroundStartingLeft"), s.data("stellar-backgroundStartingTop")) : (s.data("stellar-backgroundStartingLeft", r[0]), s.data("stellar-backgroundStartingTop", r[1])), t = "auto" === s.css("margin-left") ? 0 : parseInt(s.css("margin-left"), 10), e = "auto" === s.css("margin-top") ? 0 : parseInt(s.css("margin-top"), 10), i = s.offset().left - t - h, o = s.offset().top - e - p, s.parents().each(function() {
                    ...
                    }), t = s.data("stellar-horizontal-offset") !== f ? s.data("stellar-horizontal-offset") : n !== f && n.data("stellar-horizontal-offset") !== f ? n.data("stellar-horizontal-offset") : u.horizontalOffset, e = s.data("stellar-vertical-offset") !== f ? s.data("stellar-vertical-offset") : n !== f && n.data("stellar-vertical-offset") !== f ? n.data("stellar-vertical-offset") : u.verticalOffset, u.backgrounds.push({
                        $element: s,
                        $offsetParent: n,
                        ...
                        parentOffsetLeft: a,
                        parentOffsetTop: l,
                        stellarRatio: s.data("stellar-background-ratio") === f ? 1 : s.data("stellar-background-ratio")
                    })
                }))
            },
            _reset: function() {
            ...
            destroy: function() {
                this._reset(), this.$scrollElement.unbind("resize." + this.name).unbind("scroll." + this.name), this._animationLoop = m.noop, m(n).unbind("load." + this.name).unbind("resize." + this.name)
            },
            ...
            return e === f || "object" == typeof e ? this.each(function() {
                ...
                t instanceof c && "function" == typeof t[e] && t[e].apply(t, Array.prototype.slice.call(i, 1)), "destroy" === e && m.data(this, "plugin_" + o, null)
            }) : void 0
        }, m[o] = function(t) {
            var e = m(n);
    ...
    function(t) {
        ...
        t.prototype = {
            ...
            init: function() {
                ...
                m.isLowIE = m.isIE8 = document.all && !document.addEventListener, m.isAndroid = /android/gi.test(t), m.isIOS = /iphone|ipad|ipod/gi.test(t), m.supportsTransition = function() {
                    ...
                    return !1
                }(), m.probablyMobile = m.isAndroid || m.isIOS || /(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent), f = c(document), m.popupsCache = {}
            },
            open: function(t) {
                if (!1 === t.isObj) {
                ...
                if (!m.isOpen) {
                    m.types = [], g = "", t.mainEl && t.mainEl.length ? m.ev = t.mainEl.eq(0) : m.ev = f, t.key ? (m.popupsCache[t.key] || (m.popupsCache[t.key] = {}), m.currTemplate = m.popupsCache[t.key]) : m.currTemplate = {}, m.st = c.extend(!0, {}, c.magnificPopup.defaults, t), m.fixedContentPos = "auto" === m.st.fixedContentPos ? !m.probablyMobile : m.st.fixedContentPos, m.st.modal && (m.st.closeOnContentClick = !1, m.st.closeOnBgClick = !1, m.st.showCloseBtn = !1, m.st.enableEscapeKey = !1), m.bgOverlay || (m.bgOverlay = u("bg").on("click" + b, function() {
                        m.close()
                    }), m.wrap = u("wrap").attr("tabindex", -1).on("click" + b, function(t) {
                    ...
                    h("BeforeOpen"), m.st.showCloseBtn && (m.st.closeBtnInside ? (d(v, function(t, e, i, o) {
                    ...
                    var r = m.wH = _.height(),
                        a = {};
                    m.fixedContentPos && m._hasScrollBar(r) && ((l = m._getScrollbarSize()) && (a.marginRight = l)), m.fixedContentPos && (m.isIE7 ? c("body, html").css("overflow", "hidden") : a.overflow = "hidden");
                    var l = m.st.mainClass;
                    return m.isIE7 && (l += " mfp-ie7"), l && m._addClassToMFP(l), m.updateItemHTML(), h("BuildControls"), c("html").css(a), m.bgOverlay.add(m.wrap).prependTo(m.st.prependTo || c(document.body)), m._lastFocusedEl = document.activeElement, setTimeout(function() {
                        m.content ? (m._addClassToMFP(x), m._setFocus()) : m.bgOverlay.addClass(x), f.on("focusin" + b, m._onFocusIn)
                    }, 16), m.isOpen = !0, m.updateSize(r), h(w), t
                }
                m.updateItemHTML()
            },
            close: function() {
                m.isOpen && (h(y), m.isOpen = !1, m.st.removalDelay && !m.isLowIE && m.supportsTransition ? (m._addClassToMFP(i), setTimeout(function() {
                    m._close()
            ...
            _close: function() {
                ...
                m.bgOverlay.detach(), m.wrap.detach(), m.container.empty(), m.st.mainClass && (t += m.st.mainClass + " "), m._removeClassFromMFP(t), m.fixedContentPos && (t = {
                    marginRight: ""
                }, m.isIE7 ? c("body, html").css("overflow", "") : t.overflow = "", c("html").css(t)), f.off("keyup.mfp focusin" + b), m.ev.off(b), m.wrap.attr("class", "mfp-wrap").removeAttr("style"), m.bgOverlay.attr("class", "mfp-bg"), m.container.attr("class", "mfp-container"), !m.st.showCloseBtn || m.st.closeBtnInside && !0 !== m.currTemplate[m.currItem.type] || m.currTemplate.closeBtn && m.currTemplate.closeBtn.detach(), m.st.autoFocusLast && m._lastFocusedEl && c(m._lastFocusedEl).focus(), m.currItem = null, m.content = null, m.currTemplate = null, m.prevHeight = 0, h("AfterClose")
            },
            updateSize: function(t) {
                var e;
                m.isIOS ? (e = document.documentElement.clientWidth / window.innerWidth, e = window.innerHeight * e, m.wrap.css("height", e), m.wH = e) : m.wH = t || _.height(), m.fixedContentPos || m.wrap.css("height", m.wH), h("Resize")
            },
            updateItemHTML: function() {
                var t = m.items[m.index];
                m.contentContainer.detach(), m.content && m.content.detach(), t.parsed || (t = m.parseEl(m.index));
                var e = t.type;
                h("BeforeChange", [m.currItem ? m.currItem.type : "", e]), m.currItem = t, m.currTemplate[e] || (i = !!m.st[e] && m.st[e].markup, h("FirstMarkupParse", i), m.currTemplate[e] = !i || c(i)), n && n !== t.type && m.container.removeClass("mfp-" + n + "-holder");
                var i = m["get" + e.charAt(0).toUpperCase() + e.slice(1)](t, m.currTemplate[e]);
                m.appendContent(i, e), t.preloaded = !0, h("Change", t), n = t.type, m.container.prepend(m.contentContainer), h("AfterChange")
            },
            ...
            parseEl: function(t) {
                ...
                return i.type = e || m.st.type || "inline", i.index = t, i.parsed = !0, m.items[t] = i, h("ElementParse", i), m.items[t]
            },
            ...
            updateStatus: function(t, e) {
                var i;
                m.preloader && (o !== t && m.container.removeClass("mfp-s-" + o), e || "loading" !== t || (e = m.st.tLoading), h("UpdateStatus", i = {
                    status: t,
                    text: e
            ...
            _hasScrollBar: function(t) {
                return (m.isIE7 ? f.height() : document.body.scrollHeight) > (t || _.height())
            },
            _setFocus: function() {
            ...
            _parseMarkup: function(n, t, e) {
                ...
                e.data && (t = c.extend(e.data, t)), h(v, [n, t, e]), c.each(t, function(t, e) {
                    return void 0 === e || !1 === e || void(1 < (s = t.split("_")).length ? 0 < (i = n.find(b + "-" + s[0])).length && ("replaceWith" === (o = s[1]) ? i[0] !== e[0] && i.replaceWith(e) : "img" === o ? i.is("img") ? i.attr("src", e) : i.replaceWith(c("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(s[1], e)) : n.find(b + "-" + t).html(e));
                    var i, o
                })
            },
            ...
            return "string" == typeof t ? "open" === t ? (e = a ? n.data("magnificPopup") : n[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, o = e.items ? e.items[i] : (o = n, e.delegate && (o = o.find(e.delegate)), o.eq(i)), m._openClick({
                mfpEl: o
            }, n, e)) : m.isOpen && m[t].apply(m, Array.prototype.slice.call(arguments, 1)) : (t = c.extend(!0, {}, t), a ? n.data("magnificPopup", t) : n[0].magnificPopup = t, m.addGroup(n, t)), n
        };
            ...
            proto: {
                ...
                getInline: function(t, e) {
                    if (C(), t.src) {
                        var i, o = m.st.inline,
                            n = c(t.src);
                        return n.length ? ((i = n[0].parentNode) && i.tagName && (T || ($ = o.hiddenClass, T = u($), $ = "mfp-" + $), S = n.after(T).detach().removeClass($)), m.updateStatus("ready")) : (m.updateStatus("error", o.tNotFound), n = c("<div>")), t.inlineElement = n
                    }
        ...
        c.magnificPopup.registerModule(I, {
            ...
            proto: {
                initAjax: function() {
                    m.types.push(I), A = m.st.ajax.cursor, d(l + "." + I, z), d("BeforeChange." + I, z)
                },
                getAjax: function(o) {
                    ...
                    var t = c.extend({
                        ...
                        success: function(t, e, i) {
                            ...
                            h("ParseAjax", i), m.appendContent(c(i.data), I), o.finished = !0, E(), m._setFocus(), setTimeout(function() {
                                m.wrap.addClass(x)
        ...
        c.magnificPopup.registerModule("image", {
            ...
            proto: {
                initImage: function() {
                    var t = m.st.image,
                        e = ".image";
                    m.types.push("image"), d(w + e, function() {
                        "image" === m.currItem.type && t.cursor && c(document.body).addClass(t.cursor)
                    }), d(l + e, function() {
                        t.cursor && c(document.body).removeClass(t.cursor), _.off("resize" + b)
                ...
                _onImageHasSize: function(t) {
                    t.img && (t.hasSize = !0, P && clearInterval(P), t.isCheckingImgSize = !1, h("ImageHasSize", t), t.imgHidden && (m.content && m.content.removeClass("mfp-loading"), t.imgHidden = !1))
                },
                    ...
                    var i = 0,
                        ...
                        n = function(t) {
                            P && clearInterval(P), P = setInterval(function() {
                                return 0 < o.naturalWidth ? void m._onImageHasSize(e) : (200 < i && clearInterval(P), void(3 === ++i ? n(10) : 40 === i ? n(50) : 100 === i && n(500)))
                            }, t)
                        };
                    n(1)
                },
                getImage: function(t, e) {
                    var i, o = 0,
                        n = function() {
                            t && (t.img[0].complete ? (t.img.off(".mfploader"), t === m.currItem && (m._onImageHasSize(t), m.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, h("ImageLoadComplete")) : ++o < 200 ? setTimeout(n, 100) : s())
                        },
                        s = function() {
                        ...
                        r = m.st.image,
                        a = e.find(".mfp-img");
                    return a.length && ((i = document.createElement("img")).className = "mfp-img", t.el && t.el.find("img").length && (i.alt = t.el.find("img").attr("alt")), t.img = c(i).on("load.mfploader", n).on("error.mfploader", s), i.src = t.src, a.is("img") && (t.img = t.img.clone()), 0 < (i = t.img[0]).naturalWidth ? t.hasSize = !0 : i.width || (t.hasSize = !1)), m._parseMarkup(e, {
                        title: function(t) {
                    ...
                    }, t), m.resizeImage(), t.hasSize ? (P && clearInterval(P), t.loadError ? (e.addClass("mfp-loading"), m.updateStatus("error", r.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), m.updateStatus("ready"))) : (m.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, e.addClass("mfp-loading"), m.findImageSize(t))), e
                }
            }
        });
        var O;
            ...
            proto: {
                initZoom: function() {
                    ...
                    r.enabled && m.supportsTransition && (o = r.duration, n = function(t) {
                        ...
                        m._allowZoom() && (clearTimeout(e), m.content.css("visibility", "hidden"), (t = m._getItemToZoom()) ? ((i = n(t)).css(m._getOffset()), m.wrap.append(i), e = setTimeout(function() {
        ...
        c.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    var s = m.st.gallery,
                        t = ".mfp-gallery";
                    return m.direction = !0, !(!s || !s.enabled) && (g += " mfp-gallery", d(w + t, function() {
                        ...
                        var t, e;
                        1 < m.items.length && s.arrows && !m.arrowLeft && (e = s.arrowMarkup, t = m.arrowLeft = c(e.replace(/%title%/gi, s.tPrev).replace(/%dir%/gi, "left")).addClass(r), e = m.arrowRight = c(e.replace(/%title%/gi, s.tNext).replace(/%dir%/gi, "right")).addClass(r), t.click(function() {
                            m.prev()
                        }), e.click(function() {
                            m.next()
                ...
                _preloadItem: function(t) {
                    var e;
                    t = j(t), m.items[t].preloaded || ((e = m.items[t]).parsed || (e = m.parseEl(t)), h("LazyLoad", e), "image" === e.type && (e.img = c('<img class="mfp-img" />').on("load.mfploader", function() {
                        e.hasSize = !0
        ...
        c.magnificPopup.registerModule(q, {
            ...
            proto: {
                initRetina: function() {
                    var i, o;
                    1 < window.devicePixelRatio && (i = m.st.retina, o = i.ratio, 1 < (o = isNaN(o) ? o() : o) && (d("ImageHasSize." + q, function(t, e) {
                        e.img.css({
                            "max-width": e.img[0].naturalWidth / o,
                            width: "100%"
                        })
                    }), d("ElementParse." + q, function(t, e) {
    ...
    function(t, e) {
        ...
        ! function() {
            ...
            e.prototype.init = function() {
                ...
                m("body").append(o), this.$outer = m(".lg-outer"), this.$outer.focus(), this.$slide = this.$outer.find(".lg-item"), this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), n.setTop(), m(window).on("resize.lg orientationchange.lg", function() {
                    setTimeout(function() {
                        n.setTop()
                    }, 100)
                ...
                var t, e, i;
                "100%" !== this.s.height && (e = ((t = m(window).height()) - parseInt(this.s.height, 10)) / 2, i = this.$outer.find(".lg"), t >= parseInt(this.s.height, 10) ? i.css("top", e + "px") : i.css("top", "0px"))
                ...
                var e, i, o, n = null;
                this.s.dynamic ? this.s.dynamicEl[t].subHtmlUrl ? e = this.s.dynamicEl[t].subHtmlUrl : n = this.s.dynamicEl[t].subHtml : (i = this.$items.eq(t)).attr("data-sub-html-url") ? e = i.attr("data-sub-html-url") : (n = i.attr("data-sub-html"), this.s.getCaptionFromTitleOrAlt && !n && (n = i.attr("title") || i.find("img").first().attr("alt"))), e || (null != n ? "." !== (o = n.substring(0, 1)) && "#" !== o || (n = (this.s.subHtmlSelectorRelative && !this.s.dynamic ? i.find(n) : m(n)).html()) : n = ""), ".lg-sub-html" === this.s.appendSubHtmlTo ? e ? this.$outer.find(this.s.appendSubHtmlTo).load(e) : this.$outer.find(this.s.appendSubHtmlTo).html(n) : e ? this.$slide.eq(t).load(e) : this.$slide.eq(t).append(n), null != n && ("" === n ? this.$outer.find(this.s.appendSubHtmlTo).addClass("lg-empty-html") : this.$outer.find(this.s.appendSubHtmlTo).removeClass("lg-empty-html")), this.$el.trigger("onAfterAppendSubHtml.lg", [t])
                ...
                var n, s, r, a, l, c = this.$outer.find(".lg-current").index(),
                    d = this;
                d.lGalleryOn && c === t || (n = this.$slide.length, s = d.lGalleryOn ? this.s.speed : 0, d.lgBusy || (this.s.download && ((r = d.s.dynamic ? !1 !== d.s.dynamicEl[t].downloadUrl && (d.s.dynamicEl[t].downloadUrl || d.s.dynamicEl[t].src) : "false" !== d.$items.eq(t).attr("data-download-url") && (d.$items.eq(t).attr("data-download-url") || d.$items.eq(t).attr("href") || d.$items.eq(t).attr("data-src"))) ? (m("#lg-download").attr("href", r), d.$outer.removeClass("lg-hide-download")) : d.$outer.addClass("lg-hide-download")), this.$el.trigger("onBeforeSlide.lg", [c, t, e, i]), d.lgBusy = !0, clearTimeout(d.hideBarTimeout), ".lg-sub-html" === this.s.appendSubHtmlTo && setTimeout(function() {
                    d.addHtml(t)
                ...
                }, this.s.speed)) : (d.loadContent(t, !0, d.s.backdropDuration), d.lgBusy = !1, d.$el.trigger("onAfterSlide.lg", [c, t, e, i])), d.lGalleryOn = !0, this.s.counter && m("#lg-counter-current").text(t + 1)), d.index = t)
                ...
                t = e - t;
                15 < Math.abs(t) && (this.$outer.addClass("lg-dragging"), this.setTranslate(this.$slide.eq(this.index), t, 0), this.setTranslate(m(".lg-prev-slide"), -this.$slide.eq(this.index).width() + t, 0), this.setTranslate(m(".lg-next-slide"), this.$slide.eq(this.index).width() + t, 0))
                ...
                t || (e.$el.trigger("onBeforeClose.lg"), m(window).scrollTop(e.prevScrollTop)), t && (e.s.dynamic || this.$items.off("click.lg click.lgcustom"), m.removeData(e.el, "lightGallery")), this.$el.off(".lg.tm"), m.each(m.fn.lightGallery.modules, function(t) {
                    ...
                    e.$outer && e.$outer.remove(), m(".lg-backdrop").remove(), t || e.$el.trigger("onCloseAfter.lg"), e.$el.focus()
    ...
    function(t) {
        ...
        var p, m, t = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"],
    ...
    function(i) {
        ...
        (function(t) {
            ...
            function b() {
                var e, i;
                v.length && (h = void 0 !== n.window.pageYOffset ? n.window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop, e = p || !w || w.width !== m || w.height !== f, i = g || e || !w || w.y !== h, g = p = !1, (e || i) && (v.forEach(function(t) {
                ...
                S = (x = k, (_ = [{
                    ...
                    value: function() {
                        var t, e = this,
                            ...
                            r = 0,
                            a = o;
                        return s && (n < 0 ? (r = n * Math.max(o, f), f < o && (r -= n * (o - f))) : r = n * (o + f), 1 < n ? a = Math.abs(r - f) : n < 0 ? a = r / n + Math.abs(r) : a += (f - o) * (1 - n), r /= 2), e.parallaxScrollDistance = r, t = s ? (f - a) / 2 : (o - a) / 2, e.css(e.image.$item, {
                            height: a + "px",
                            marginTop: t + "px",
    ...
    function() {
        ...
        function y() {
            var t, e, i, o, n, s;
            !u && document.body && (u = !0, t = document.body, e = document.documentElement, s = window.innerHeight, i = t.scrollHeight, h = 0 <= document.compatMode.indexOf("CSS") ? e : t, c = t, m.keyboardSupport && L("keydown", _), top != self ? d = !0 : Z && s < i && (t.offsetHeight <= s || e.offsetHeight <= s) && ((o = document.createElement("div")).style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + h.scrollHeight + "px", document.body.appendChild(o), a = function() {
                n = n || setTimeout(function() {
                    l || (o.style.height = "0", o.style.height = h.scrollHeight + "px", n = null)
                }, 500)
            }, setTimeout(a, 10), L("resize", a), (r = new W(a)).observe(t, {
                attributes: !0,
                childList: !0,
                characterData: !1
            }), h.offsetHeight <= s && ((s = document.createElement("div")).style.clear = "both", t.appendChild(s))), m.fixedBackground || l || (t.style.backgroundAttachment = "scroll", e.style.backgroundAttachment = "scroll"))
        }
        var v = [],
            w = !1,
            b = Date.now();
        ...
        function x(c, d, u) {
            var t, e, i, h, p;
            t = 0 < (t = d) ? 1 : -1, e = 0 < (e = u) ? 1 : -1, o.x === t && o.y === e || (o.x = t, o.y = e, v = [], b = 0), 1 != m.accelerationMax && ((e = Date.now() - b) < m.accelerationDelta && (1 < (i = (1 + 50 / e) / 2) && (i = Math.min(i, m.accelerationMax), d *= i, u *= i)), b = Date.now()), v.push({
                x: d,
                y: u,
                lastX: d < 0 ? .99 : -.99,
                lastY: u < 0 ? .99 : -.99,
                start: Date.now()
            }), w || (i = R(), h = c === i || c === document.body, null == c.$scrollBehavior && function(t) {
                var e = T(t);
                null == E[e] && (t = getComputedStyle(t, "")["scroll-behavior"], E[e] = "smooth" == t);
                return E[e]
            }(c) && (c.$scrollBehavior = c.style.scrollBehavior, c.style.scrollBehavior = "auto"), p = function(t) {
                for (var e = Date.now(), i = 0, o = 0, n = 0; n < v.length; n++) {
                    var s = v[n],
                        r = e - s.start,
                        a = r >= m.animationTime,
                        l = a ? 1 : r / m.animationTime;
                    m.pulseAlgorithm && (l = function(t) {
                        if (1 <= t) return 1;
                        if (t <= 0) return 0;
                        1 == m.pulseNormalize && (m.pulseNormalize /= F(1));
                        return F(t)
                    }(l));
                    r = s.x * l - s.lastX >> 0, l = s.y * l - s.lastY >> 0;
                    i += r, o += l, s.lastX += r, s.lastY += l, a && (v.splice(n, 1), n--)
                }
                h ? window.scrollBy(i, o) : (i && (c.scrollLeft += i), o && (c.scrollTop += o)), d || u || (v = []), v.length ? B(p, c, 1e3 / m.frameRate + 1) : (w = !1, null != c.$scrollBehavior && (c.style.scrollBehavior = c.$scrollBehavior, c.$scrollBehavior = null))
            }, B(p, c, 0), w = !0)
        }
        ...
        function t(t) {
            ...
            if (D(c, "embed") || D(e, "embed") && /\.pdf/i.test(e.src) || D(c, "object") || e.shadowRoot) return !0;
            var i = -t.wheelDeltaX || t.deltaX || 0,
                o = -t.wheelDeltaY || t.deltaY || 0;
            p && (t.wheelDeltaX && q(t.wheelDeltaX, 120) && (i = t.wheelDeltaX / Math.abs(t.wheelDeltaX) * -120), t.wheelDeltaY && q(t.wheelDeltaY, 120) && (o = t.wheelDeltaY / Math.abs(t.wheelDeltaY) * -120)), i || o || (o = -t.wheelDelta || 0), 1 === t.deltaMode && (i *= 40, o *= 40);
            e = I(e);
            return e ? !! function(t) {
                if (!t) return;
                s.length || (s = [t, t, t]);
                t = Math.abs(t), s.push(t), s.shift(), clearTimeout(n), n = setTimeout(function() {
                    try {
                ...
                var e = 120 < t && H(t),
                    e = !H(120) && !H(100) && !e;
                return t < 50 || e
            }(o) || (1.2 < Math.abs(i) && (i *= m.stepSize / 120), 1.2 < Math.abs(o) && (o *= m.stepSize / 120), x(e, i, o), t.preventDefault(), void z()) : !d || !G || (Object.defineProperty(t, "target", {
        ...
        function _(t) {
            var e = t.target,
                i = t.ctrlKey || t.altKey || t.metaKey || t.shiftKey && t.keyCode !== f.spacebar;
            document.body.contains(c) || (c = document.activeElement);
            var o = /^(button|submit|radio|checkbox|file|color|image)$/i;
            if (t.defaultPrevented || /^(textarea|select|embed|object)$/i.test(e.nodeName) || D(e, "input") && !o.test(e.type) || D(c, "video") || function(t) {
                    var e = t.target,
                        i = !1;
            ...
            var n = 0,
                s = 0,
                r = I(c);
            if (!r) return !d || !G || parent.keydown(t);
            ...
            x(r, n, s), t.preventDefault(), z()
        }

        function e(t) {
            c = t.target
        }
        var C, $, T = (C = 0, function(t) {
                return t.uniqueID || (t.uniqueID = C++)
            }),
            S = {},
            k = {},
            E = {};
        ...
        function A(t, e, i) {
            for (var o = i ? S : k, n = t.length; n--;) o[T(t[n])] = e;
            return e
        }
        ...
        function I(t) {
            ...
            do {
                ...
                if (e.push(t), o === t.scrollHeight) {
                    n = O(h) && O(i) || M(h);
                    if (d && P(h) || !d && n) return A(e, R())
                } else if (P(t) && M(t)) return A(e, t)
        ...
        function H(t) {
            return q(s[0], t) && q(s[1], t) && q(s[2], t)
        }
        var V, B = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(t, e, i) {
                window.setTimeout(t, i || 1e3 / 60)
            },
            W = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver,
            R = (V = document.scrollingElement, function() {
                var t, e;
                return V || ((t = document.createElement("div")).style.cssText = "height:10000px;width:1px;", document.body.appendChild(t), e = document.body.scrollTop, document.documentElement.scrollTop, window.scrollBy(0, 3), V = document.body.scrollTop != e ? document.body : document.documentElement, window.scrollBy(0, -3), document.body.removeChild(t)), V
            });

        function F(t) {
            var e;
            return ((t *= m.pulseScale) < 1 ? t - (1 - Math.exp(-t)) : (--t, (e = Math.exp(-1)) + (1 - Math.exp(-t)) * (1 - e))) * m.pulseNormalize
        }
        var N = window.navigator.userAgent,
            ...
            X = /safari/i.test(N) && !Y,
            Q = /mobile/i.test(N),
            Y = /Windows NT 6.1/i.test(N) && /rv:11/i.test(N),
            Z = X && (/Version\/8/i.test(N) || /Version\/9/i.test(N)),
            Y = (G || X || Y) && !Q,
            U = !1;
        try {
        ...
        var Q = !!U && {
            ...
            K = "onwheel" in document.createElement("div") ? "wheel" : "mousewheel";

        function J(t) {
            for (var e in t) i.hasOwnProperty(e) && (m[e] = t[e])
        }
        K && Y && (L(K, t, Q), L("mousedown", e), L("load", y)), J.destroy = function() {
            r && r.disconnect(), j(K, t), j("mousedown", e), j("keydown", _), j("resize", a), j("load", y)
