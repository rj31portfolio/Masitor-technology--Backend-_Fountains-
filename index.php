...
// Fetch last 3 blogs
$blogs = [];
$blogResult = $conn->query("SELECT title, slug, feature_image, meta_description FROM blog_posts WHERE status='published' ORDER BY published_at DESC LIMIT 3");
if ($blogResult) {
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card h-100">
                                    <img src="<?php echo BASE_URL; ?>admin/categories/uploads/categories/<?php echo htmlspecialchars($cat['image']); ?>"
                                        class="card-img-top" alt="<?php echo htmlspecialchars($cat['name']); ?>" />
                                    <div class="card-body">
                                        <h5 class="card-title"><?php echo htmlspecialchars($cat['name']); ?></h5>
                                        <p class="card-text"><?php echo htmlspecialchars($cat['short_description']); ?>
                                        </p>
                                        <a href="category.php?slug=<?php echo htmlspecialchars($cat['slug']); ?>"
                                            class="btn-style1">Explore</a>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; ?>
            ...
            <div class="col-lg-6 text-center">
                <div class="testimonial-carousel2 owl-carousel owl-theme">
                    ...
                    <div>
                        ...
                        <p class="mb-1-9 display-28 display-md-26 w-sm-85 mx-auto text-white opacity4 font-weight-400">
        ...
        <div class="row align-items-center mt-n2-9">
            ...
            ">↻</button>
                                ...
                                <div class="col-md-12" style="margin-top:14px;">
                                    <button class="btn-style1 border-0" type="submit"><span><span class="btn-small">Send
...
<section class="bg-light">
    <div class="container">
        ...
        <div class="row g-xl-5 mt-n1-9">
            ...
            <div class="col-md-6 col-lg-4 mt-1-9 wow fadeIn" data-wow-delay="<?php echo (100 + $i * 50); ?>ms">
                <article class="card card-style06 border-0 rounded-0 h-100">
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="card-img-text"><a href="#">Blog</a></div>
                    </div>
                    <div class="card-body position-relative pt-2-6 pb-1-9 pb-xl-2-6 px-1-9 px-xl-2-4">
                        ...
                        <p class="mt-2"><?php echo htmlspecialchars($blog['meta_description']); ?></p>
                    </div>
                </article>
            </div>
            <?php endforeach; ?>
